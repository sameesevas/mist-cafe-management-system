    ...
    <main>
        ...
        <!-- <section class="module-small">
            <div class="container">
              ...
              <option>Payal</option>
              <option>Bangals</option>
               <option>Chockers</option> 
        </select>
                    </div>
                    <div class="col-sm-3">
                ...
                <div class="row multi-columns-row">
                    <div class="col-sm-6 col-md-3 col-lg-3">
                        <div class="shop-item">
                            ...
                            <h4 class="shop-item-title font-alt"><a href="shop_single_product.html">OXIDISED EARRING</a></h4>₹ 150
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3 col-lg-3">
                        <div class="shop-item">
                            ...
                            <h4 class="shop-item-title font-alt"><a href="#">DESIGNER JUTE NECKLACE</a></h4>₹ 200
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3 col-lg-3">
                        <div class="shop-item">
                            ...
                            <h4 class="shop-item-title font-alt"><a href="#">FINGER RING</a></h4>₹ 180
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3 col-lg-3">
                        <div class="shop-item">
                            ...
                            <h4 class="shop-item-title font-alt"><a href="#">DESIGNER JHUMKI</a></h4>₹ 200
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3 col-lg-3">
                        <div class="shop-item">
